                        ...
                        <div class="mask flex-center">
                            <div class="container">
                                <div class="row align-items-center">
                                    <div class="col-md-7 col-12 order-md-6 order-1" style="margin-top: 100px;margin-left:70px;">
                                        <h4>M I Z U R I</h4>
                                        <p>Hi Wibu! mau ngapain mint?</p> <br>
                                    </div>
                                    <div class="col-md-4 col-12 order-md-2 order-1" ><img src="alwaysbeme.png" class="mx-auto" alt="slide"></div>
                                </div>
                            </div>
                        </div>
                    </div>
